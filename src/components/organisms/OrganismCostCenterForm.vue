<template>
  <div class="organism-cost-center-form">
    <div class="organism-cost-center-form__inner">
      <AtomHeadline tag="h1" text="Kostenstelle anlegen" />
      <form>
        ...
        <AtomParagraph v-if="nameDuplicate" class="organism-cost-center-form__duplicate-account xfin__form__error" text="Dieser Name existiert bereits!" />

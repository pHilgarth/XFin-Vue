...
export const errorService = {
    errorMessages: {
        ...
        bankAccount:                                accountErrorMessage,
        bic:                                        bicErrorMessage,
        //costCenter:                               'Diese Kostenstelle passt nicht zum gewählten Transaktions-Typ!',
        creditorAccount:                            accountErrorMessage,
        debitorAccount:                             accountErrorMessage,

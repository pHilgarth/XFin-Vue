...
export const router = createRouter({
    ...
    routes: [
        ...
        { path: '/account-holders',         name: 'account-holders',        component: AccountHolders },
        { path: '/budget-manager',          name: 'budget-manager',         component: BudgetManager },
        { path: '/debt-manager',            name: 'debt-manager',           component: DebtManager },
        { path: '/edit-account-holder',     name: 'edit-account-holder',    component: EditAccountHolder, props: true },
        { path: '/new-account-holder',      name: 'new-account-holder',     component: NewAccountHolder },
        { path: '/new-loan',                name: 'new-loan',               component: NewLoan },
        { path: '/new-overheads',           name: 'new-overheads',          component: NewOverheads},
        { path: '/new-reserve/',            name: 'new-reserve',            component: NewReserve },
        { path: '/overheads',               name: 'overheads',              component: Overheads},
        { path: '/recurring-revenues',      name: 'recurring-revenues',     component: RecurringRevenues },
        { path: '/recurring-transaction',   name: 'recurring-transaction',  component: RecurringTransaction },
        { path: '/reserves',                name: 'reserves',               component: ReserveManager },
